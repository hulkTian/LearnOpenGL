...
object IMyNativeRendererType {
    ...
    const val SAMPLE_TYPE_FRAME_CUBE_MAPS = SAMPLE_TYPE + 25
    const val SAMPLE_TYPE_FRAME_CUBE_MAPS_REFLECTION1 = SAMPLE_TYPE + 26
    const val SAMPLE_TYPE_FRAME_CUBE_MAPS_REFLECTION2 = SAMPLE_TYPE + 27
    const val SAMPLE_TYPE_FRAME_CUBE_MAPS_REFRACTION = SAMPLE_TYPE + 28
    const val SAMPLE_TYPE_FRAME_CUBE_MAPS_EXERCISE = SAMPLE_TYPE + 29
    const val SAMPLE_TYPE_FRAME_CUBE_UNIFORM_BUFFER = SAMPLE_TYPE + 30
    const val SAMPLE_TYPE_FRAME_GEOMETRY_SHADER = SAMPLE_TYPE + 31
}
