...
#define SAMPLE_TYPE_ADVANCED_GLSL_POINT_SIZE                        (SAMPLE_TYPE + 22.0f)
#define SAMPLE_TYPE_ADVANCED_GLSL_FRAGCOORD                         (SAMPLE_TYPE + 22.1f)
#define SAMPLE_TYPE_ADVANCED_GLSL_FRONT_FACING                      (SAMPLE_TYPE + 22.2f)
#define SAMPLE_TYPE_ADVANCED_GLSL_FRAG_DEPTH                        (SAMPLE_TYPE + 22.3f)
#define SAMPLE_TYPE_CUBE_UNIFORM_BUFFER                             (SAMPLE_TYPE + 22.5f)
#define SAMPLE_TYPE_GEOMETRY_SHADER                                 (SAMPLE_TYPE + 23.0f)
#define SAMPLE_TYPE_GEOMETRY_SHADER_TRIANGLE_STRIP                  (SAMPLE_TYPE + 23.1f)
#define SAMPLE_TYPE_GEOMETRY_SHADER_EXPLODE                         (SAMPLE_TYPE + 23.2f)
#define SAMPLE_TYPE_GEOMETRY_SHADER_NORMAL                          (SAMPLE_TYPE + 23.3f)
