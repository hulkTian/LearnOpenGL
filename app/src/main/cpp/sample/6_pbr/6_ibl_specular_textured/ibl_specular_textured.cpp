...
void ibl_specular_textured::Create() {
    ...
    m_ProgramObj = GLUtils::createProgram("shaders/vs_pbr_ibl_specular.glsl", "shaders/fs_pbr_ibl_specular_textured.glsl");
    ...
    if (!m_ProgramObj || !m_ProgramObj_Equirectangular_To_Cubemap || !m_ProgramObj_Irradiance
        || !m_ProgramObj_Prefilter || !m_ProgramObj_Brdf || !m_ProgramObj_Background) {
    ...
    setInt(m_ProgramObj, "albedoMap", 3);
    setInt(m_ProgramObj, "normalMap", 4);
    setInt(m_ProgramObj, "metallicMap", 5);
    setInt(m_ProgramObj, "roughnessMap", 6);
    setInt(m_ProgramObj, "aoMap", 7);
    ...
    // --------------------------
    // rusted iron
    ironAlbedoMap = GLUtils::loadTgaTexture("textures/pbr/rusted_iron/albedo.png");
    ironNormalMap = GLUtils::loadTgaTexture("textures/pbr/rusted_iron/normal.png");
    ironMetallicMap = GLUtils::loadTgaTexture("textures/pbr/rusted_iron/metallic.png");
    ironRoughnessMap = GLUtils::loadTgaTexture("textures/pbr/rusted_iron/metallic.png");
    ironAOMap = GLUtils::loadTgaTexture("textures/pbr/rusted_iron/ao.png");

    // gold
    goldAlbedoMap = GLUtils::loadTgaTexture("textures/pbr/gold/albedo.png");
    goldNormalMap = GLUtils::loadTgaTexture("textures/pbr/gold/normal.png");
    goldMetallicMap = GLUtils::loadTgaTexture("textures/pbr/gold/metallic.png");
    goldRoughnessMap = GLUtils::loadTgaTexture("textures/pbr/gold/metallic.png");
    goldAOMap = GLUtils::loadTgaTexture("textures/pbr/gold/ao.png");

    // grass
    grassAlbedoMap = GLUtils::loadTgaTexture("textures/pbr/grass/albedo.png");
    grassNormalMap = GLUtils::loadTgaTexture("textures/pbr/grass/normal.png");
    grassMetallicMap = GLUtils::loadTgaTexture("textures/pbr/grass/metallic.png");
    grassRoughnessMap = GLUtils::loadTgaTexture("textures/pbr/grass/metallic.png");
    grassAOMap = GLUtils::loadTgaTexture("textures/pbr/grass/ao.png");

    // plastic
    plasticAlbedoMap = GLUtils::loadTgaTexture("textures/pbr/plastic/albedo.png");
    plasticNormalMap = GLUtils::loadTgaTexture("textures/pbr/plastic/normal.png");
    plasticMetallicMap = GLUtils::loadTgaTexture("textures/pbr/plastic/metallic.png");
    plasticRoughnessMap = GLUtils::loadTgaTexture("textures/pbr/plastic/metallic.png");
    plasticAOMap = GLUtils::loadTgaTexture("textures/pbr/plastic/ao.png");

    // wall
    wallAlbedoMap = GLUtils::loadTgaTexture("textures/pbr/wall/albedo.png");
    wallNormalMap = GLUtils::loadTgaTexture("textures/pbr/wall/normal.png");
    wallMetallicMap = GLUtils::loadTgaTexture("textures/pbr/wall/metallic.png");
    wallRoughnessMap = GLUtils::loadTgaTexture("textures/pbr/wall/metallic.png");
    wallAOMap = GLUtils::loadTgaTexture("textures/pbr/wall/ao.png");
...
void ibl_specular_textured::generateEnvironmentMap()
{
    // pbr: load the HDR environment map
    // ---------------------------------
    GLuint hdrTexture = GLUtils::loadHDRTexture("textures/hdr/newport_loft.hdr");
...
void ibl_specular_textured::generateIrradianceMap()
{
...
void ibl_specular_textured::generatePreFilterMap() {
...
void ibl_specular_textured::generateBrdfLUT()
{
...
void ibl_specular_textured::Draw() {
...
void ibl_specular_textured:: renderQuad()
{
    if (quadVAO == 0)
    {
        float quadVertices[] = {
...
void ibl_specular_textured::renderCube() {
...
void ibl_specular_textured::renderSphere() {
    if (sphereVAO == 0) {
...
void ibl_specular_textured::Shutdown() {
