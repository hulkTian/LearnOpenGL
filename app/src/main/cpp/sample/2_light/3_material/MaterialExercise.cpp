...
#include "MaterialExercise.h"
REGISTER_SAMPLE(SAMPLE_TYPE_COLORS_MATERIAL_EXERCISE, MaterialExercise)
...
void MaterialExercise::Draw() {
    ...
    // light properties
    setVec3(m_ProgramObj,"light.ambient", 1.0f, 1.0f, 1.0f);
    setVec3(m_ProgramObj,"light.diffuse", 1.0f, 1.0f, 1.0f);
    setVec3(m_ProgramObj,"light.specular", 1.0f, 1.0f, 1.0f);

    // material properties
    setVec3(m_ProgramObj,"material.ambient", 0.0f, 0.1f, 0.06f);
    setVec3(m_ProgramObj,"material.diffuse", 0.0f, 0.50980392f, 0.50980392f);
    setVec3(m_ProgramObj,"material.specular", 0.50196078f, 0.50196078f, 0.50196078f);
...
void MaterialExercise::Shutdown() {
    //关闭顶点属性
