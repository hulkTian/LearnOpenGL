...
#include "ColorsLightExercise4.h"
#include "glm/ext/matrix_clip_space.hpp"
#include "glm/ext/matrix_transform.hpp"
REGISTER_SAMPLE(SAMPLE_TYPE_COLORS_VIEW_EXERCISE_4, ColorsLightExercise4)
// 3D盒子顶点坐标和纹理坐标
...
void ColorsLightExercise4::Create() {
    GLUtils::printGLInfo();
...
void ColorsLightExercise4::Draw() {
    ...
    setFloat(m_ProgramObj, "diffuseStrength",
             glm::max<float>(0.1f, 0.01f * static_cast<float >(seek2)));
    //设置镜面反射因子
    setFloat(m_ProgramObj, "specularStrength",
             glm::max<float>(0.1f, 0.1f * static_cast<float >(seek3)));
...
void ColorsLightExercise4::Shutdown() {
    //关闭顶点属性
