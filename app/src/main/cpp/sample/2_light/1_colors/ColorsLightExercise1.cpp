...
#include "ColorsLightExercise1.h"
#include "glm/ext/matrix_clip_space.hpp"
#include "glm/ext/matrix_transform.hpp"
REGISTER_SAMPLE(SAMPLE_TYPE_COLORS_VIEW_EXERCISE_1, ColorsLightExercise1)
// 3D盒子顶点坐标和纹理坐标
...
void ColorsLightExercise1::Create() {
    GLUtils::printGLInfo();
...
void ColorsLightExercise1::Draw() {
...
void ColorsLightExercise1::Shutdown() {
    //关闭顶点属性
