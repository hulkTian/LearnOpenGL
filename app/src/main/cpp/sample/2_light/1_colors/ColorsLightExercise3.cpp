...
#include "ColorsLightExercise3.h"
#include "glm/ext/matrix_clip_space.hpp"
#include "glm/ext/matrix_transform.hpp"
REGISTER_SAMPLE(SAMPLE_TYPE_COLORS_VIEW_EXERCISE_3, ColorsLightExercise3)
// 3D盒子顶点坐标和纹理坐标
...
void ColorsLightExercise3::Create() {
    GLUtils::printGLInfo();
    ...
    //创建着色器程序,并编译着色器代码
    m_ProgramObj = GLUtils::createProgram("shaders/vs_colors_exercise_3.glsl",
...
void ColorsLightExercise3::Draw() {
    ...
    //设置观察空间的光源位置，用户计算漫反射光
    setVec3(m_ProgramObj, "lightPos", view * glm::vec4(lightPos, 1.0f));
...
void ColorsLightExercise3::Shutdown() {
    //关闭顶点属性
