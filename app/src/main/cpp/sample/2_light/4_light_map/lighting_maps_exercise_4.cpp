...
#include "lighting_maps_exercise_4.h"
REGISTER_SAMPLE(SAMPLE_TYPE_LIGHTING_MAPS_EXERCISE_4, lighting_maps_exercise_4)
...
void lighting_maps_exercise_4::Create() {
    GLUtils::printGLInfo();
    ...
    //加载自发光贴图
    emissionMap = GLUtils::loadTgaTexture("textures/matrix.jpg");
...
void lighting_maps_exercise_4::Draw() {
...
void lighting_maps_exercise_4::Shutdown() {
    //关闭顶点属性
