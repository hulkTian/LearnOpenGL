...
#include "lighting_maps_exercise_2.h"
...
void lighting_maps_exercise_2::Create() {
    GLUtils::printGLInfo();
    ...
    m_ProgramObj = GLUtils::createProgram("shaders/vs_lighting_maps.glsl",
                                          "shaders/fs_lighting_maps_exercise_2.glsl");
...
void lighting_maps_exercise_2::Draw() {
...
void lighting_maps_exercise_2::Shutdown() {
    //关闭顶点属性
